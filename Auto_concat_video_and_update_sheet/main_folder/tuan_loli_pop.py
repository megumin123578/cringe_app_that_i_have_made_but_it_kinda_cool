...
CSV_FILE = r"C:\Users\Admin\Documents\main\Tuan_number\csv_data\tuan_lolipop_asmr.csv"  # Source for additional videos
SCOPES = [
...
OUTPUT_DIR = r'\\hai2\Video đã ren\Khay đen\lolipop'
MAX_AGE_SECONDS = 55 * 24 * 60 * 60  * 0 
USED_LOG_FILE = r'"C:\Users\Admin\Documents\main\Tuan_number\log_data\tuan_loli_pop.log"'
...
def main():
    ...
    for ls in results:
        ...
        filename = f"{name}_tuan_lolipop.mp4"
