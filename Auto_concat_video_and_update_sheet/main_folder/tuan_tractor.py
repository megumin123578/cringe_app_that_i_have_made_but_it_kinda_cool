...
CSV_FILE = r"C:\Users\Admin\Documents\main\Tuan_number\csv_data\tuan_tractor_data.csv"  # Source for additional videos
SCOPES = [
...
OUTPUT_DIR = r'F:\ouput\OUTPUT Tractor'
MAX_AGE_SECONDS = 55 * 24 * 60 * 60  * 0 
USED_LOG_FILE = r"C:\Users\Admin\Documents\main\Tuan_number\log_data\tuan_tractor.log"
...
def main():
    ...
    for ls in results:
        ...
        filename = f"{name}_Tuan_tractor_ghep.mp4"
    ...
    try:
        ...
        excel_to_sheet(EXCEL_FILE, SHEET_NAME,2)
