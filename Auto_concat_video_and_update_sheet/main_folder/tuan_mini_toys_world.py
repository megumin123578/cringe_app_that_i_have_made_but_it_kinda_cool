...
CSV_FILE = r"C:\Users\Admin\Documents\main\Tuan_number\csv_data\mini_toys_world.csv"  # Source for additional videos
SCOPES = [
...
OUTPUT_DIR = r'\\hai2\Video đã ren\Doll\output'
MAX_AGE_SECONDS = 55 * 24 * 60 * 60  * 0 
USED_LOG_FILE = r"C:\Users\Admin\Documents\main\Tuan_number\csv_data\mini_toys_world.log"
...
def main():
    ...
    for ls in results:
        ...
        filename = f"{name}_tuan_mini_toy.mp4"
    ...
    try:
        ...
        excel_to_sheet(EXCEL_FILE, SHEET_NAME,4)
